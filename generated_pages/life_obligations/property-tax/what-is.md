...
* Tax rate: the percentage of the property's value that is used to calculate the tax amount
* Exemptions: certain types of properties or property owners that are exempt from paying property taxes, such as churches or non-profit organizations
* Abatements: reductions in the tax amount that are granted to property owners who meet certain criteria, such as having a low income
* Appeals: the process by which property owners can dispute their tax assessment or tax bill
* Liens: legal claims against a property that are used to secure payment of unpaid taxes

There are several common misconceptions about property tax, including:
* The belief that property taxes are only paid by homeowners, when in fact they can be paid by owners of all types of property, including commercial and industrial properties
* The idea that property taxes are a fixed amount, when in fact they can vary from year to year based on changes in the property's value or the tax rate
* The assumption that property taxes are only used to fund local government services, when in fact they can also be used to pay for state or federal programs
* The notion that property taxes are always fair and equitable, when in fact they can be influenced by a variety of factors, including the assessor's methodology and the tax rate

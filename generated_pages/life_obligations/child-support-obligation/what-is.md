...
* The amount of money to be paid by the non-custodial parent
* The frequency of payments, such as monthly or biweekly
* The method of payment, such as direct deposit or check
* The duration of the child support obligation, which can be until the child reaches a certain age or becomes self-supporting
* The ability to modify the child support obligation if circumstances change, such as a change in income or custody arrangement
* The potential consequences for failing to pay child support, such as wage garnishment or other enforcement actions
...
* Child support is only paid by the father, when in fact either parent can be required to pay child support
* Child support is only used to pay for luxuries, when in fact it is typically used to pay for basic necessities like food and clothing
* Child support obligations can be avoided by moving to a different location, when in fact child support obligations can be enforced across state or even national borders
* Child support obligations end when the child turns 18, when in fact the duration of child support obligations can vary depending on the laws of the relevant jurisdiction

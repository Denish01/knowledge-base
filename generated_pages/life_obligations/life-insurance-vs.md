...
* Premiums: the amount of money paid by the policyholder to maintain coverage
* Coverage period: the length of time that the policy is in effect
* Beneficiaries: the individuals or entities that receive the death benefit
* Riders: additional features or benefits that can be added to the policy, such as waiver of premium or accidental death benefit
* Underwriting: the process of evaluating the policyholder's risk and determining their eligibility for coverage

Some common misconceptions about life insurance vs other forms of insurance include:
* That life insurance is only for older individuals or those with dependents
* That life insurance is too expensive or unnecessary
* That other forms of insurance, such as health insurance, provide the same level of coverage as life insurance
* That life insurance policies are inflexible or cannot be changed

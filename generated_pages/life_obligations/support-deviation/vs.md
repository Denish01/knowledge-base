---
title: "Support Deviation Compared"
...
* The mean, which is the average value of a set of data
* The standard deviation, which is a measure of the amount of variation or dispersion of a set of data from the mean
* The expected or standard performance, which is the target or desired level of performance
* The actual performance, which is the measured level of performance
* The degree of variation, which is the difference between the actual and expected performance
* The statistical methods used to measure and analyze the data, such as regression analysis and hypothesis testing

There are several common misconceptions about support deviation vs, including:
* That support deviation vs is only relevant in manufacturing or production environments
* That support deviation vs is only concerned with reducing variation, rather than understanding and managing it
* That support deviation vs is a complex and difficult concept to understand and apply
* That support deviation vs is not relevant in service-based industries or organizations

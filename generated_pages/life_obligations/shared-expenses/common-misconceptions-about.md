...
- Myth: Splitting all expenses 50/50 is the fairest way to divide costs.
...
- Myth: Utilities are always split evenly among roommates.
...
- Myth: Rent is the only expense that needs to be split when living with roommates.
...
- Myth: It's not necessary to track shared expenses.
...
- Myth: One person should always be in charge of paying the bills.
...
- Myth: Shared expenses only apply to roommates.

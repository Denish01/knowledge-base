...
* The amount of money the employer contributes to the employee's plan
* The amount of money the employee must contribute to the plan in order to receive the employer match
* The type of plan the employer match is being used with, such as a 401(k) or 403(b) plan
* The vesting schedule, which determines when the employer's contributions belong fully to the employee
* The limit on the amount of money the employer will contribute to the plan
* The rules for how the employer match is invested and managed

Some common misconceptions about employer matches include:
* That all employers offer an employer match, when in fact it is an optional benefit
* That the employer match is always 100%, when in fact it can be a lower percentage
* That the employer match is the same for all employees, when in fact it can vary depending on the employee's job or tenure with the company
* That the employer match is only used with retirement plans, when in fact it can be used with other types of savings plans as well

...
* The type of expense or investment that qualifies for the credit, such as education expenses or home improvements
* The amount of the credit, which can be a fixed amount or a percentage of the qualifying expense
* The eligibility requirements, such as income limits or other qualifications
* The documentation required to support the claim, such as receipts or invoices
* The refundability of the credit, which determines whether it can result in a refund
* The carryover provisions, which allow unused credits to be carried over to future tax years

Some common misconceptions about tax credits include:
* That tax credits are the same as tax deductions, when in fact they have different effects on the amount of tax owed
* That all tax credits are refundable, when in fact some are non-refundable
* That tax credits can only be claimed by individuals, when in fact businesses can also claim tax credits
* That tax credits are only available for certain types of expenses, when in fact there are many different types of tax credits available

...
5. **Geographic Eligibility Criteria**
...
| --- | --- | --- | --- |
| Demographic | Based on personal characteristics | Quantifiable data, targets specific populations | Scholarship program for students under 25 |
| Financial | Based on financial situation | Financial resources, determines financial aid eligibility | Government program for low-income families |
| Academic | Based on educational background or performance | Academic record, determines academic program eligibility | University program with GPA and coursework requirements |
| Medical | Based on health status or medical condition | Medical history, determines medical treatment eligibility | Health insurance program for individuals with pre-existing conditions |
| Geographic | Based on location or residence | Address or location, determines program or service eligibility | Community development program for specific regions |

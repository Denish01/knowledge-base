---
title: "Income Shares Model Compared"
...
* Ownership shares: the percentage of ownership held by each party
* Income distribution: the allocation of income to each party based on their ownership shares
* Proportional allocation: the income is distributed in proportion to each party's ownership share
* Direct link: the model creates a direct link between ownership and income
* Flexibility: the model can provide more flexibility in responding to changes in income levels
* Aligning interests: the model can align the interests of the parties involved by creating a direct link between ownership and income

However, there are some common misconceptions about the income shares model, including:
* That it is only suitable for large businesses or investments
* That it is too complex or difficult to implement
* That it can create conflicts or disputes among the parties involved
* That it is not suitable for businesses with variable or unpredictable income streams

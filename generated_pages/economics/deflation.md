...
* A potential decrease in consumer spending and business investment
* A potential decrease in economic growth and employment
* A potential increase in the burden of debt, as the value of money increases over time

Some common misconceptions about deflation include:
* That deflation is always bad for the economy, when in fact it can have both positive and negative effects
* That deflation is the same as disinflation, which is a decrease in the rate of inflation, rather than a decrease in the general price level
* That deflation is caused by a single factor, when in fact it can be caused by a combination of factors
* That deflation always leads to economic depression, when in fact it can be a normal part of the economic cycle

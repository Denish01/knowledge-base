...
## Comparison Table
| Category | Primary Goal | Instrument | Risk |
| --- | --- | --- | --- |
| **Monetary Authority** | Price stability | Interest rates | Low |
| **Currency Board** | Exchange rate stability | Foreign exchange reserves | High |
| **Central Bank with Supervisory Powers** | Financial stability | Regulation | Medium |
| **Hybrid Central Bank** | Balanced stability | Multiple instruments | Medium |

...
1. **Price Stability** - as it is the primary objective of a central bank and its absence can lead to hyperinflation, as seen in Zimbabwe.
2. **Fiscal Discipline** - as it is necessary to prevent excessive government borrowing, which can lead to high inflation and decreased confidence in the currency.
3. **Independent Monetary Policy** - as it allows the central bank to set interest rates and regulate the money supply without political interference.
4. **Effective Supervision and Regulation** - as it is necessary to prevent bank failures and maintain financial stability.
5. **Clear Communication** - as it helps to manage expectations and maintain transparency.
6. **Operational Independence** - as it allows the central bank to operate without fear of political retribution.

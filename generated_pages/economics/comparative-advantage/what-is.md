...
* Specialization, which refers to the process of focusing on producing a particular good or service
* Trade, which refers to the exchange of goods or services between countries or individuals
* Efficiency, which refers to the ability to produce goods or services with a minimum of waste or excess cost
* Comparative advantage, which refers to the ability of a country or individual to produce a particular good or service at a lower opportunity cost than others
* Absolute advantage, which refers to the ability of a country or individual to produce a particular good or service more efficiently than others

Some common misconceptions about comparative advantage include:
* The idea that a country or individual must have an absolute advantage in producing a particular good or service in order to benefit from trade
* The idea that trade only benefits the country or individual that has a comparative advantage
* The idea that comparative advantage is only relevant for countries, and not for individuals
* The idea that comparative advantage is a static concept, and that it does not change over time

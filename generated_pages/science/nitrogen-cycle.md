...
* Nitrogen fixation, the process by which nitrogen gas is converted into ammonia
* Ammonification, the process by which organic matter is broken down into ammonia
* Nitrification, the process by which ammonia is converted into nitrite and then into nitrate
* Denitrification, the process by which nitrate is converted back into nitrogen gas
* Assimilation, the process by which plants and animals use nitrogen to build proteins and other tissues
* Decomposition, the process by which dead organisms are broken down and their nutrients, including nitrogen, are released back into the environment
...
* That nitrogen is not an essential nutrient for plants and animals
* That the nitrogen cycle only occurs in soil and not in other environments, such as the ocean
* That human activities, such as farming and industrial processes, do not impact the nitrogen cycle
* That the nitrogen cycle is a simple, linear process, rather than a complex, circular one

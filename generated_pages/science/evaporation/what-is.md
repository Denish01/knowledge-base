...
* Heat energy: provides the energy needed for water molecules to transition from a liquid to a gas state
* Surface tension: the force that acts on the surface of a liquid, opposing the escape of molecules into the air
* Humidity: the amount of water vapor present in the air, which affects the rate of evaporation
* Wind speed: the speed at which air moves over the surface of a liquid, which can increase or decrease the rate of evaporation
* Temperature: the temperature of the surrounding air, which affects the rate of evaporation
* Air pressure: the pressure exerted by the air on the surface of a liquid, which can also affect the rate of evaporation

Common misconceptions about evaporation include:
* That evaporation only occurs in warm weather, when in fact it can occur at any temperature
* That evaporation is the same as boiling, when in fact boiling involves the formation of bubbles within a liquid, whereas evaporation occurs at the surface
* That evaporation is a slow process, when in fact it can occur rapidly under the right conditions
* That evaporation only occurs in bodies of water, when in fact it can occur in any liquid, including solutions and mixtures

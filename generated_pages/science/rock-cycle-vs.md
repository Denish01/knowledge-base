...
* Sedimentary rocks, which are formed from the accumulation and compaction of sediments
* Metamorphic rocks, which are formed from the transformation of existing rocks by heat and pressure
* Weathering and erosion, which break down rocks into sediments
* Deposition, which involves the transportation and accumulation of sediments in a new location
* Plate tectonics, which drives the movement of rocks and the formation of mountains and volcanoes

Common misconceptions about the rock cycle include:
* That rocks are static and unchanging, when in fact they are constantly being formed, transformed, and destroyed
* That the rock cycle is a linear process, when in fact it is a complex and cyclical process
* That metamorphic rocks are always formed from sedimentary rocks, when in fact they can be formed from any type of rock
* That the rock cycle only occurs on a large scale, when in fact it can also occur on a small scale, such as in a laboratory or in a backyard

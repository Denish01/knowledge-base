...
* Tax withholding, which is the amount of taxes taken out of a person's paycheck
* Tax credits, which are amounts that can be subtracted from a person's tax liability
* Tax deductions, which are expenses that can be subtracted from a person's income to reduce their tax liability
* Filing status, which determines the tax rates and credits a person is eligible for
* Tax returns, which are the documents used to report income and tax payments to the government
* Refund offset, which is the process of using a tax refund to pay other debts owed to the government

Some common misconceptions about tax refunds include:
* That a tax refund is a bonus or free money from the government, when in fact it is simply a return of excess taxes paid
* That a person must have filed their tax return by a certain deadline to be eligible for a refund, when in fact a person can file their tax return at any time and still receive a refund if they are eligible
* That a tax refund can only be received by mail, when in fact many governments offer direct deposit as a faster and more convenient option
* That a tax refund is not subject to any fees or charges, when in fact some tax preparation services may charge a fee to prepare and file a tax return

...
* Finding a common denominator, which is a common multiple of the denominators of the fractions being compared
* Converting fractions to have the same denominator, which allows for direct comparison
* Comparing the numerators of the fractions to determine which fraction is larger or smaller
* Understanding equivalent fractions, which are fractions that have the same value but different numerators and denominators
* Recognizing that fractions can be represented in different forms, such as mixed numbers or improper fractions
* Applying mathematical operations, such as adding, subtracting, multiplying, and dividing fractions, which requires accurate comparisons

Some common misconceptions about comparing fractions include:
* Assuming that the fraction with the larger numerator is always larger, which is not true if the denominators are different
* Believing that fractions with the same numerator are equal, which is not true if the denominators are different
* Thinking that comparing fractions is only necessary for simple fractions, when in fact it is essential for all types of fractions, including complex and mixed numbers
* Assuming that finding a common denominator is always straightforward, when in fact it can be challenging, especially with large denominators

...
* Investing regardless of the market's performance
* Reducing the impact of market volatility on investments
* Lowering the average cost per unit of the investment over time
* Using a long-term investment strategy
* Disciplined approach to investing, with a commitment to invest a fixed amount of money at regular intervals

Some common misconceptions about dollar cost averaging include:
* That it is a way to guarantee high returns on investments
* That it is only suitable for beginner investors
* That it is a way to time the market or predict its ups and downs
* That it is a complex or difficult investment strategy to implement

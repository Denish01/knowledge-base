...
* Net asset value, which is the total value of the fund's assets minus its liabilities, divided by the number of outstanding shares
* Portfolio diversification, which helps to reduce risk by spreading investments across different asset classes and industries
* Investment objective, which is the fund's stated goal, such as long-term growth or income generation
* Expense ratio, which is the percentage of the fund's assets that are used to cover operating costs
* Minimum investment requirement, which is the minimum amount of money that an investor must invest to participate in the fund
* Dividend and capital gains distributions, which are the payments made to investors from the fund's earnings

Some common misconceptions about mutual funds include:
* That mutual funds are only for wealthy investors, when in fact they can be a viable option for investors of all income levels
* That mutual funds are too risky, when in fact they can be a relatively low-risk investment option, especially when compared to individual stocks or other securities
* That mutual funds are too complicated, when in fact they can be a simple and straightforward way to invest in a diversified portfolio
* That mutual funds guarantee a certain return, when in fact all investments carry some level of risk and there are no guarantees
